...
export default function PageBrowse() {
  const resourceTypesList: any = [
    {label: 'PREDICT reference dataset', uri: 'http://purl.org/np/RAWWaT9M_Nd8cVm_-amJErz60Ak__tkS6ROi2P-swdmMw'},
    {
      ...
      uri: 'http://purl.org/np/RAaZp4akBZI6FuRzIpeksyYxTArOtxqmhuv9on-YssEzA'
    },
    {
  ...
  return (
    <Container className="mainContainer">
      ...
      <h2>🔍️ Browse Nanopublications</h2>
      ...
      {!state.loading_nanopubs && (
        <p style={{fontSize: '12.5px'}}>🗃️ {Object.keys(state.nanopub_obj).length} nanopublications found</p>
      )}
