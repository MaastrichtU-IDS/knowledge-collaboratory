...
export default function PageAnnotate() {
  ...
  const extractionOptions = [
    'Extract entities with OpenAI GPT-3.5 turbo',
    'Extract entities with OpenAI GPT-3 text-davinci-003',
    'Extract entities with OpenAI GPT-3 code-davinci-002',
  ...
  const extractOpenAI = () => {
    axios
      .post(
        ...
        {
          // headers: { Authorization: `Bearer ${$userProfile.access_token}` },
          params: {
  ...
  return (
    <Container className="mainContainer">
      <h2>🏷️ Annotate biomedical text</h2>
      <p>
      ...
      <Popper open={open} anchorEl={anchorEl} style={{zIndex: '1000'}}>
        <ClickAwayListener onClickAway={handleClickAway}>
          <Card
            elevation={4}
            style={{opacity: 1, minWidth: '80px', padding: '16px 16px', textAlign: 'left', zIndex: '9000'}}
          >
            {state.tagSelected && (
              <>
