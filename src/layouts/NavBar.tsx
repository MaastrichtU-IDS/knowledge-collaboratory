  ...
  return (
    <AppBar title="" position='static'>
      <Toolbar variant='dense'>
        <a href={`${settings.basePath}/`} style={{alignItems: 'center', display: 'flex'}}>
        ...
        <a href={`${settings.basePath}/`} className="linkButton">
        ...
        <a href={`${settings.basePath}/annotate`} className="linkButton">
        ...
        <a href={`${settings.basePath}/shape-publisher`} className="linkButton">
        ...
        <Tooltip title='Access the OpenAPI documentation of the API used by this service'>
          ...
          href={settings.docsUrl}>
            <img
              src={`${settings.basePath}/openapi_logo.svg`}
              alt="OpenAPI"
              width={18}
              height={18}
              // fill
        ...
        <a href={`${settings.basePath}/about`} className="linkButton">
          <Tooltip title='About'>
        ...
        <Tooltip title='Source code'>
          <Button style={{color: '#fff'}} target="_blank" href="https://github.com/MaastrichtU-IDS/knowledge-collaboratory">
            <img
              ...
              src={`${settings.basePath}/github.svg`}
              alt="GitHub"
              width={20}
              height={20}
              // fill
